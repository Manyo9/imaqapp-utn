...
import { ServiceDetailIDDTO, ServicesIDDTO } from 'src/app/models/Service';
...
export class DetailsServicesComponent {
  ...
  service: ServicesIDDTO;
  details: ServiceDetailIDDTO[] = [];
  ...
  private loadRequest(): void {
    this.subs.add(
      this.activatedRoute.params.subscribe((params) => {
        ...
        this.subs.add(
          this.requestService.getServiceRequest(id).subscribe({
            next: (result: ApiResult) => {
              if (result.ok && result.result) {
                this.request = result.result.request as RequestIDDTO;
                this.service = result.result.service as ServicesIDDTO;
                this.details = result.result.details as ServiceDetailIDDTO[];
              } else {
